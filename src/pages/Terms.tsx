...
export default function Terms() {
  ...
  return (
    <div className="bg-background min-h-screen pb-20 md:pb-0" id="terms-of-service-page">
      <SEO 
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          ...
          >
            ...
            <p className="text-white/50 text-sm">
              {t("terms.effective_date")} <span className="text-white/70">{t("terms.date")}</span>
            </p>
      ...
      <div className="container mx-auto px-4 max-w-3xl py-16">
        ...
        >
          <p>{t("terms.footer_text", { year: new Date().getFullYear() })}</p>
